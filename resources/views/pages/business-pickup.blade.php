    ...
    <section class="page-header">
        ...
        <div class="container">
            <div class="page-header__inner">
                <h2>Business Pickup</h2>
                <ul class="thm-breadcrumb list-unstyled">
                    <li><a href="{{ '/' }}">Home</a></li>
                    <li><a href="{{ 'services' }}">Services</a></li>
                    <li class="active">Business Pickup</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="service-details__left">
                        <div class="service-details__category">
                            ...
                            <ul class="service-details__cagegory-list list-unstyled">
                                ...
                                <li><a href="{{ 'zero-waste' }}">Zero Waste <span class="fa fa-arrow-right"></span></a>
                                </li>
                                ...
                                <li class="active"><a href="{{ 'business-pickup' }}">Business Pickup <span
                                            class="fa fa-arrow-right"></span></a></li>
                        ...
                        <div class="service-details__banner">
                            <div class="service-details__banner-content">
                                <h3 class="service-details__banner-title">We Don’t Just Manage Waste. We Provide a
                                    Solutions.</h3>
                                <div class="service-details__banner-shape-1 float-bob-y"><img
                                        src="assets/images/shapes/service-details-banner-shape-1.png" alt=""></div>
                            </div>
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="service-details__right">
                        ...
                        <div class="service-details__content">
                            <h3 class="service-details__content-title">Business Pickup</h3>
